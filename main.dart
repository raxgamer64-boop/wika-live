                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: const RadialGradient(
                      ...
                      radius: .9,
                      colors: [Color(0xFFFFC86B), Color(0xFF9A36FF), Color(0xFF2A0A62)],
                      stops: [0.0, .48, 1.0],
                    ),
                    border: Border.all(color: const Color(0xFFFFD98A), width: 1.4),
                    boxShadow: const [
                      BoxShadow(color: Color(0xCC9E35FF), blurRadius: 16, spreadRadius: 1),
                      BoxShadow(color: Color(0x66FFB24D), blurRadius: 8),
                    ],
                  ),
                ),
                Icon(Icons.shield_rounded, color: Colors.white, size: size * .54),
                Positioned(
                  top: -5,
                  child: Icon(
                    Icons.workspace_premium_rounded,
                    ...
                    size: size * .42,
                    shadows: const [Shadow(color: Color(0xFFFF8A00), blurRadius: 7)],
                  ),
                ),
              ],
            ),
