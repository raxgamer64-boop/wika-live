                ...
                if (login)
                  Align(
                    ...
                    child: TextButton(
                      onPressed: () => msg(
                        context,
                        'Password reset can be added from Firebase Authentication.',
                      ),
                      child: const Text(
                        'Forgot password?',
                        style: TextStyle(
...
class _LiveScreenState extends State<LiveScreen> {
  ...
  Widget _demoGrid(BuildContext context, List<Map<String, dynamic>> hosts, String empty) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) => _liveCard(context, hosts[index]),
    );
  }
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, index) {
          ...
          return ChoiceChip(
            ...
            backgroundColor: Colors.white,
            side: BorderSide(color: active ? primary : const Color(0xFFE5DCEB)),
            labelStyle: TextStyle(
              color: active ? Colors.white : const Color(0xFF302A38),
              fontWeight: FontWeight.w800,
              fontSize: 13,
            ),
              ...
              children: options.map((item) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: active ? const Color(0xFFF0E1FA) : Colors.transparent,
                      borderRadius: BorderRadius.circular(11),
                    ),
                    child: Text(item, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: active ? primaryDark : Colors.black45)),
                  ),
                );
              }).toList(),
            ),
          ...
          Padding(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(colors: [Color(0xFF20142F), Color(0xFF6B2D87)]),
                  borderRadius: BorderRadius.circular(16),
    ...
    return Center(
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(24), border: Border.all(color: const Color(0xFFE9DDF1))),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(height: 6),
            Text(subtitle, textAlign: TextAlign.center, style: const TextStyle(color: Colors.black45, fontSize: 12, height: 1.4)),
          ]),
        ),
      ),
    );
...
class _LiveRoomPageState extends State<LiveRoomPage> {
  ...
  void _gift() {
    setState(() {
      giftProgress = (giftProgress + 1).clamp(0, 12);
    });
  ...
  @override
  Widget build(BuildContext context) {
    final progress = giftProgress / 12;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: _liveVideoBackground(widget.photoUrl),
          ),

          // Top atmospheric gradient for readable controls.
          Positioned(
            top: 0,
            left: 0,
            right: 0,
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  CircleAvatar(
                    radius: 23,
                    backgroundColor: const Color(0xFF5D35B5),
                  ...
                  _followPill(),
                  const SizedBox(width: 7),
                  _roomIcon(Icons.more_horiz_rounded, _showRoomMenu),
                  const SizedBox(width: 4),
                  _roomIcon(Icons.close_rounded, () => Navigator.pop(context)),
                ],
              ),
            ),
          ),
          ...
          Positioned(
            ...
            child: SafeArea(
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    _tag(Icons.emoji_events_rounded, 'Hourly Rank'),
                    _tag(Icons.public_rounded, 'India'),
                    _tag(Icons.local_fire_department_rounded, '28.7K'),
                    _tag(Icons.chat_bubble_rounded, 'Chat'),
                  ],
                ),
              ),
            ),
            ...
            child: AnimatedSwitcher(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(22),
                  border: Border.all(
                    color: const Color(0x66E96CFF),
                  ),
                  boxShadow: const [
                    BoxShadow(
                      color: Color(0x553F0D82),
                      blurRadius: 18,
                    ),
                  ],
                ),
                child: Row(
                  children: [
                    const CircleAvatar(
                      radius: 15,
                      backgroundColor: Color(0xFF8A4BDE),
                      child: Icon(
                    ...
                    Expanded(
                      child: Text(
                        giftProgress == 0
                            ...
                            : 'Angel sent Rocket 🚀 x$giftProgress',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                          color: Colors.white,
            ...
            child: Column(
              children: [
                ...
                _floatingTool(
                  ...
                  'Join',
                  const Color(0xFF8C55FF),
                  () => _toast('Guest seats opened'),
                ),
                const SizedBox(height: 10),
                _floatingTool(
                  Icons.emoji_events_rounded,
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: const Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.circle, color: Color(0xFF32E6A1), size: 7),
                  SizedBox(width: 6),
                  Text(
                    'LIVE',
                    style: TextStyle(
              ...
              child: Row(
                children: [
                  ...
                  _bottomAction(
                    ...
                    () => _toast('Reactions opened'),
                  ),
                  _bottomAction(
                    showPk
                        ? Icons.sports_mma_rounded
                        : Icons.flash_on_rounded,
                    () => setState(() => showPk = !showPk),
                  ),
                  _bottomAction(
                    liked
                    ...
                    color: liked ? const Color(0xFFFF4E9B) : Colors.white,
                  ),
                  _bottomAction(Icons.card_giftcard_rounded, _gift),
                ],
              ),
            ),
          ),
  ...
  Widget _liveVideoBackground(String? url) {
    // Do not use the host's DP as the full-screen live video.
    // Until a real streaming SDK is connected, show a clean simulated
    // live-stage so the room UI can be reviewed without stretching a photo.
    return _demoLiveStage(url);
  }

  Widget _demoLiveStage(String? url) {
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment.topCenter,
        ...
        children: [
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    const Color(0xFF9D35FF).withValues(alpha: .30),
                    Colors.transparent,
                  ],
                ),
              ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    const Color(0xFF4D7CFF).withValues(alpha: .18),
                    Colors.transparent,
                  ],
                ),
              ),
          ...
          Center(
            child: Container(
              width: 255,
              height: 360,
              margin: const EdgeInsets.only(top: 55, bottom: 70),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(30),
                gradient: const LinearGradient(
                  begin: Alignment.topCenter,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: const [
                        BoxShadow(
                          color: Color(0x663F00FF),
                          blurRadius: 24,
                        ),
                      ],
                    ),
                    child: CircleAvatar(
                      backgroundColor: const Color(0xFF30204A),
                      backgroundImage:
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Real camera stream will appear here',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.white54,
                      fontSize: 11,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0x2218E6A3),
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: const Color(0x5518E6A3),
                      ),
                    ),
                    child: const Row(
                      mainAxisSize: MainAxisSize.min,
          ...
          Positioned(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _stageChip(Icons.wifi_rounded, 'Excellent'),
                const SizedBox(width: 8),
                _stageChip(Icons.remove_red_eye_rounded, widget.viewers),
              ],
            ),
          ),
        ],
  ...
  Widget _stageChip(IconData icon, String label) {
    return Container(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: following
              ? const LinearGradient(
                  colors: [Color(0xFF8C58FF), Color(0xFFB13EFF)],
                )
              : const LinearGradient(
                  colors: [Color(0xFFFF4DAE), Color(0xFF8A47FF)],
                ),
          borderRadius: BorderRadius.circular(18),
        ),
        child: Text(
  ...
  Widget _tag(IconData icon, String text) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, color: const Color(0xFFFFD65A), size: 14),
          const SizedBox(width: 5),
          Text(
            text,
            style: const TextStyle(
  ...
  Widget _pkBanner() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFE32686), Color(0xFF5B38E8)],
        ),
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: const Color(0x99FFFFFF)),
        boxShadow: const [
          BoxShadow(color: Color(0x774A16A8), blurRadius: 20),
        ],
      ),
      child: const Column(
        children: [
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: color.withValues(alpha: .30), blurRadius: 16),
              ],
            ),
            child: Icon(icon, color: color, size: 24),
          ),
  ...
  void _toast(String text) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: const Color(0xFF271A46),
      ),
    );
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _menuRow(Icons.share_rounded, 'Share live'),
                _menuRow(Icons.report_rounded, 'Report room'),
                _menuRow(Icons.block_rounded, 'Block host'),
              ],
            ),
          ),
        );
  ...
  Widget _menuRow(IconData icon, String title) {
    return ListTile(
      ...
      leading: Icon(icon, color: const Color(0xFFD28AFF)),
      title: Text(
        title,
        style: const TextStyle(
          color: Colors.white,
