...
class _GuestCallOverlay extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                _toolSection('Basic tools', [
                  ...
                  _sheetTool(Icons.videocam_rounded, 'Camera', () => controller.audioVideo.camera.switchState()),
                  _sheetTool(Icons.flip_camera_android_rounded, 'Mirror', () => msg(sheetContext, 'Camera mirror control is in the live toolbar.')),
  ...
  Widget _toolSection(String title, List<Widget> children) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: const TextStyle(color: Color(0xFFAAA3B5), fontSize: 12, fontWeight: FontWeight.w800)),
        const SizedBox(height: 8),
        GridView.count(
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(),
  ...
  Widget _sheetTool(IconData icon, String label, VoidCallback onTap) {
    return InkWell(
      ...
      borderRadius: BorderRadius.circular(16),
      child: Container(
        decoration: BoxDecoration(color: const Color(0xFF17151F), borderRadius: BorderRadius.circular(16), border: Border.all(color: const Color(0xFF292437))),
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(icon, color: const Color(0xFFD46BFF), size: 25), const SizedBox(height: 7), Text(label, textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w800))]),
      ),
    );
  }
}
