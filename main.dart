...
class GameCenterPage extends StatelessWidget {
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              _featuredGame(context, 'Jungle Hunter', '🦁', const Color(0xFFFFA726), const SlotMachinePage()),
              const SizedBox(height: 14),
              GridView.count(
                crossAxisCount: 2,
                shrinkWrap: true,
                ...
                childAspectRatio: .93,
                children: [
                  _gameTile(context, 'Jungle Hunter', '🎰', const Color(0xFFFF9F43), const SlotMachinePage()),
                  _gameTile(context, 'Chubby Poko', '🐷', const Color(0xFFFFC857), const LuckyBoxPage()),
                  _gameTile(context, 'Fruit Roulette', '🍓', const Color(0xFF36D399), const RoulettePage()),
                  _gameTile(context, 'Sea Hunter', '🦈', const Color(0xFF38BDF8), const LuckySpinPage()),
                  _gameTile(context, 'Golden Train', '🚂', const Color(0xFFFFD76A), const TreasureWheelPage()),
                  _gameTile(context, 'Greedy Cat', '🐱', const Color(0xFF8D7BFF), const GreedyChestPage()),
                  _gameTile(context, 'Bali Trip', '🏝️', const Color(0xFFFF7AA2), const LuckyDrawPage()),
                  _gameTile(context, 'Zeus', '⚡', const Color(0xFFB388FF), const TreasureWheelPage()),
                  _gameTile(context, 'Crash', '🚀', const Color(0xFF4DA6FF), const NumberRushPage()),
                  _gameTile(context, 'World Cup', '🏆', const Color(0xFF22C55E), const DiceGamePage()),
                  _gameTile(context, 'Crash Cricket', '🏏', const Color(0xFFFF8A65), const DiceGamePage()),
                  _gameTile(context, 'Plinko', '🔵', const Color(0xFF60A5FA), const LuckyDropPage()),
                  _gameTile(context, 'Boss Fishing', '🎣', const Color(0xFF22D3EE), const LuckySpinPage()),
                  _gameTile(context, 'Lucky Number', '🔢', const Color(0xFFFFC857), const NumberRushPage()),
                  _gameTile(context, 'Teen Patti', '🃏', const Color(0xFFEF4444), const CardFlipPage()),
                  _gameTile(context, 'Dragon vs Tiger', '🐉', const Color(0xFFF59E0B), const CardFlipPage()),
                  _gameTile(context, 'Glider Spin', '🎡', const Color(0xFFA78BFA), const TreasureWheelPage()),
                  _gameTile(context, 'Fruit Ferris Wheel', '🎠', const Color(0xFF34D399), const LuckySpinPage()),
                  _gameTile(context, '2048 Fusion', '🔮', const Color(0xFFF472B6), const NumberRushPage()),
                  _gameTile(context, 'Knife Master', '🎯', const Color(0xFF10B981), const LuckyDrawPage()),
                ],
              ),
              const SizedBox(height: 10),
              _gameNote(),
  ...
  Widget _featuredGame(BuildContext context, String title, String emoji, Color accent, Widget page) =>
      Material(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [accent.withAlpha(230), const Color(0xFF321052), const Color(0xFF130A20)],
              ),
              border: Border.all(color: const Color(0xFFFFD76A), width: 1.5),
              boxShadow: [BoxShadow(color: accent.withAlpha(65), blurRadius: 24, offset: const Offset(0, 10))],
            ),
            child: Stack(
              children: [
                Positioned(right: -18, top: -18, child: Text(emoji, style: const TextStyle(fontSize: 118))),
                Padding(
                  padding: const EdgeInsets.all(18),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.end, children: [
                    Container(padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 4), decoration: BoxDecoration(color: Colors.redAccent, borderRadius: BorderRadius.circular(20)), child: const Text('HOT', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 10))),
                    const SizedBox(height: 6),
                    Text(title, style: const TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w900)),
                    const Text('FREE ENTRY • WIN COINS', style: TextStyle(color: Color(0xFFFFE79A), fontSize: 11, fontWeight: FontWeight.w900)),
                  ],),
                ),
              ],
            ),
  ...
  Widget _gameTile(BuildContext context, String title, String emoji, Color accent, Widget page) =>
      Material(
        color: Colors.transparent,
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(19),
              gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [accent.withAlpha(215), const Color(0xFF21122E)]),
              border: Border.all(color: accent.withAlpha(95)),
              boxShadow: [BoxShadow(color: accent.withAlpha(30), blurRadius: 12)],
            ),
            child: Stack(
              children: [
                Positioned(right: 7, top: 7, child: Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 3), decoration: BoxDecoration(color: Colors.redAccent, borderRadius: BorderRadius.circular(12)), child: const Text('FREE', style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.w900)))),
                Center(
                  child: Padding(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: Colors.white.withAlpha(55), width: 1.5),
                          ),
                        ...
                        const Text('PLAY', style: TextStyle(color: Color(0xFFFFD76A), fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 1.2)),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _gameNote() => Container(
        ...
        child: const Row(crossAxisAlignment: CrossAxisAlignment.start, children: [Icon(Icons.info_outline_rounded, color: Color(0xFFFFD76A), size: 20), SizedBox(width: 10), Expanded(child: Text('WikaLive games have FREE ENTRY — no Coins are required to start. Rewards are virtual Coins and stay inside the app and can be used for supported in-app gifting and features; they are not cash.', style: TextStyle(color: Colors.white60, height: 1.35, fontSize: 12)))]),
      );
}
