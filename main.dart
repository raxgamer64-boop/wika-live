...
class _GuestCallOverlayState extends State<_GuestCallOverlay> {
      ...
      builder: (context, roomSnapshot) {
        ...
        return Stack(
          ...
          children: [
            ...
            // Host identity — compact, like the reference live-room header.
            Positioned(
              top: top + 10,
              left: 12,
              width: 304,
            ...
            // Guardian + real contribution avatars.
            Positioned(
              top: top + 5,
              left: 306,
              right: 112,
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 7),
                  _roundGlass(Icons.close_rounded, 44, () => _confirmClose(context)),
                ],
              ),
            ),

            // Top contributor / diamonds.
            Positioned(
              top: top + 86,
              left: 12,
            ...
            Positioned(
              ...
              child: StreamBuilder<List<ZegoInRoomMessage>>(
                ...
                builder: (context, messageSnapshot) {
                  ...
                  final visible = messages.length > 4 ? messages.sublist(messages.length - 4) : messages;
                  ...
                  children: List.generate(
                    ...
                    (index) => Padding(
                      ...
                      child: Icon(
                        ...
                        color: index.isEven ? const Color(0xFFFF2F9F) : const Color(0xFFFF62C0),
                        size: 34,
                      ),
                    ),
                  ),
            ...
            // Chat + controls share one clean bottom row.
            Positioned(
              left: 14,
              right: 14,
              bottom: bottom + 10,
  ...
  Widget _hostIdentity(String name, String photo, int level) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xC90B0C10),
        borderRadius: BorderRadius.circular(34),
        border: Border.all(color: Colors.white.withOpacity(.12)),
        boxShadow: const [BoxShadow(color: Color(0x44000000), blurRadius: 14, offset: Offset(0, 4))],
      ),
      child: Row(
        children: [
          Stack(
            ...
            children: [
              _avatar(url: photo, name: name, radius: 23),
              Positioned(
                right: -1,
                bottom: -1,
                child: Container(
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    const Icon(Icons.shield_rounded, color: Color(0xFFFFD447), size: 23),
                  ],
                ),
                const SizedBox(height: 3),
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(colors: [Color(0xFF8A35FF), Color(0xFFB82BFF)]),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Text(
                    '♛ Lv.$level',
  ...
  Widget _rankingStrip() {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: uid == null ? const Stream<QuerySnapshot<Map<String, dynamic>>>.empty() : _rankStream(uid),
      builder: (context, snapshot) {
        ...
        return Row(
          ...
          children: [
            _guardianBadge(),
            if (shown.isNotEmpty) const SizedBox(width: 7),
  ...
  Widget _rankDataAvatar(int rank, String name, String photo, int level, int sent) {
    final ring = rank == 1
        ...
        : rank == 2
            ? const Color(0xFF8FD5FF)
            : const Color(0xFFFF9C72);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xCC101116),
                borderRadius: BorderRadius.circular(9),
              ),
              child: Text(
                'Lv.$level',
                style: TextStyle(color: ring, fontSize: 8, fontWeight: FontWeight.w900),
              ),
            ),
            if (sent > 0)
              Text(
                _shortNumber(sent),
                style: const TextStyle(color: Colors.white70, fontSize: 7, fontWeight: FontWeight.w700),
              ),
          ],
        ),
      ),
  ...
  Widget _diamondPill(int value) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.diamond_rounded, color: Color(0xFFC94FFF), size: 22),
          const SizedBox(width: 7),
          Text(
            _shortNumber(value),
          ...
          const SizedBox(width: 7),
          const Icon(Icons.chevron_right_rounded, color: Colors.white70, size: 19),
        ],
      ),
    );
  }
  ...
  Widget _topContributionCard() {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        final docs = snapshot.data?.docs ?? const <QueryDocumentSnapshot<Map<String, dynamic>>>[];
        final value = docs.isNotEmpty && docs.first.data()['diamondsSent'] is num
            ? (docs.first.data()['diamondsSent'] as num).toInt()
            : 0;
        ...
        return Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Icon(Icons.local_fire_department_rounded, color: Color(0xFFFF743D), size: 19),
              const SizedBox(width: 5),
              const Text('Top 1', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 13)),
              const SizedBox(width: 9),
              const Icon(Icons.diamond_rounded, color: Color(0xFFC94FFF), size: 18),
  ...
  Widget _chatInput() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [BoxShadow(color: Color(0x44000000), blurRadius: 12, offset: Offset(0, 3))],
      ),
      child: Row(
        children: [
          Expanded(
          ...
          IconButton(
            ...
            splashRadius: 20,
            icon: const Icon(Icons.emoji_emotions_outlined, color: Colors.white, size: 23),
          ),
        ],
      ),
    );
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 54,
              decoration: BoxDecoration(
                color: const Color(0xD90B0C11),
                shape: BoxShape.circle,
                border: Border.all(color: Colors.white.withOpacity(.12)),
                boxShadow: const [BoxShadow(color: Color(0x44000000), blurRadius: 10)],
              ),
              child: Icon(
                icon,
                color: active ? Colors.white : const Color(0xFFFF6AAE),
                size: 25,
              ),
            ),
            const SizedBox(height: 3),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  ...
                  colors: [Color(0xFFFF35C7), Color(0xFF8D21FF)],
                ),
                border: Border.all(color: Colors.white.withOpacity(.55)),
                boxShadow: const [BoxShadow(color: Color(0xAA9D21FF), blurRadius: 15)],
              ),
  ...
  Widget _chatBubble(String name, String message) {
    return Container(
      ...
      padding: const EdgeInsets.fromLTRB(5, 5, 12, 6),
      decoration: BoxDecoration(
        color: const Color(0xC90B0C10),
        borderRadius: BorderRadius.circular(18),
              ...
              children: [
                Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        name.isEmpty ? 'WikaLive User' : name,
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
