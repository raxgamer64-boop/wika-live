...
class MeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        final photo = rawPhotos is List && rawPhotos.isNotEmpty
            ? rawPhotos.first.toString()
          ...
          child: SafeArea(
            child: ListView(
              ...
              children: [
                ...
                _profileHero(context, name, shortId, photo),
                const SizedBox(height: 14),
                ...
                ], onTap: (tool) => openPage(context, _toolPage(tool.label))),
                const SizedBox(height: 14),
  ...
  Widget _profileHero(BuildContext context, String name, String id, String photo) {
    return InkWell(
          ...
          children: [
            Stack(children: [
              Container(
                ...
                decoration: const BoxDecoration(shape: BoxShape.circle, gradient: LinearGradient(colors: [Color(0xFFFFD37A), Color(0xFFFF6FB4)])),
                child: ClipOval(
                  child: photo.isEmpty
                      ? Container(color: const Color(0xFFE8D7F8), child: const Icon(Icons.person_rounded, color: Color(0xFF5B3A8F), size: 45))
                      : Image.network(photo, fit: BoxFit.cover, errorBuilder: (_, __, ___) => Container(color: const Color(0xFFE8D7F8), child: const Icon(Icons.person_rounded, color: Color(0xFF5B3A8F), size: 45))),
                ),
              ),
              Positioned(right: 0, bottom: 0, child: InkWell(onTap: () => openPage(context, const EditProfilePage()), child: Container(width: 27, height: 27, decoration: const BoxDecoration(color: Colors.white, shape: BoxShape.circle), child: const Icon(Icons.camera_alt_rounded, size: 15, color: primary)))),
            ]),
            const SizedBox(width: 14),
            Expanded(
  ...
  Widget _statsCard(BuildContext context, String uid) {
    return Container(
      ...
      child: Row(children: [
        _countStat(context, uid, 'moments', 'Moments', const MomentsScreen()),
        _divider(),
