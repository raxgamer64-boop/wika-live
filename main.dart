  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        height: 78,
        backgroundColor: const Color(0xFF090B1B),
        elevation: 0,
        shadowColor: const Color(0x66000000),
        selectedIndex: index,
        indicatorColor: const Color(0x332D1E5C),
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          return TextStyle(
            ...
            color: states.contains(WidgetState.selected)
                ? const Color(0xFFD36CFF)
                : const Color(0xFF9A9EB4),
          );
        }),
        destinations: const [
          NavigationDestination(
            icon: Icon(Icons.live_tv_outlined),
            selectedIcon: Icon(Icons.live_tv_rounded, color: Color(0xFFD36CFF)),
            label: 'Live',
          ),
          NavigationDestination(
            icon: Icon(Icons.campaign_outlined),
            selectedIcon: Icon(Icons.campaign_rounded, color: Color(0xFFD36CFF)),
            label: 'Party',
          ),
          NavigationDestination(
            icon: Icon(Icons.explore_outlined),
            selectedIcon: Icon(Icons.explore_rounded, color: Color(0xFFD36CFF)),
            label: 'Moments',
          ),
          NavigationDestination(
            icon: Icon(Icons.chat_bubble_outline_rounded),
            selectedIcon: Icon(Icons.chat_bubble_rounded, color: Color(0xFFD36CFF)),
            label: 'Message',
          ),
          NavigationDestination(
            icon: Icon(Icons.person_outline_rounded),
            selectedIcon: Icon(Icons.person_rounded, color: Color(0xFFD36CFF)),
            label: 'Me',
          ),
        ],
      ),
