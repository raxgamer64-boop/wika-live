...
class _GuestCallOverlayState extends State<_GuestCallOverlay> {
      ...
      builder: (context, roomSnapshot) {
        ...
        return DefaultTextStyle.merge(
          ...
          child: Stack(
            ...
            // CUSTOM CHAT INPUT + BOTTOM TOOLBAR (MORE / BEAUTY / MIC / GIFT)
            // Both live in ONE Row so the button row is measured first and
            // always gets the width it needs; the input simply takes
            // whatever space is left. This is what stops the Gift button
            // from being pushed off-screen on narrower phones — the old
            // layout split the bar into two independent fixed-percentage
            // halves, and on smaller screens the button half was narrower
            // than the four buttons actually needed, clipping the last one.
            Positioned(
              left: _refX(14),
              bottom: 48,
              child: SizedBox(
      ...
      builder: (context, snapshot) {
        ...
        return Row(
          ...
          children: List.generate(docs.length, (index) {
            ...
            final level = d['level'] is num ? (d['level'] as num).toInt() : 1;
            final diamondsSent = d['diamondsSent'] is num ? (d['diamondsSent'] as num).toInt() : 0;
      ...
      child: Column(
        ...
        children: [
          Stack(
            ...
            children: [
              ...
              Container(
                ...
                child: _avatar(url: photo, name: name, radius: 22),
              ),
            ],
          ),
          const SizedBox(height: 3),
          Row(
            ...
            children: [
              Icon(
                diamondsSent > 0 ? Icons.card_giftcard_rounded : Icons.workspace_premium_rounded,
                color: diamondsSent > 0 ? const Color(0xFFFF4DB8) : Colors.white,
                size: 11,
              ),
              const SizedBox(width: 2),
              Text(
                diamondsSent > 0 ? _shortNumber(diamondsSent) : 'Lv.$level',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 10,
                  fontWeight: FontWeight.w900,
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: Color(0x9A8E3CFF), blurRadius: 14, spreadRadius: 1),
                  ],
                ),
                child: const Stack(
                  alignment: Alignment.center,
                  children: [
                    ...
                    Icon(Icons.star_rounded, color: Color(0xFFD8A6FF), size: 29),
                  ],
                ),
              ),
              const Positioned(
  ...
  double _refX(double value) {
    final width = MediaQuery.sizeOf(context).width;
    return value * width / 864.0;
  }
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(color: Color(0x8CB523FF), blurRadius: 12, spreadRadius: 1),
                ],
              ),
