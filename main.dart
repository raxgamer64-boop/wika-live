        ...
        children: [
          ...
          if (diamondsSent > 0)
            Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Icon(Icons.card_giftcard_rounded, color: Color(0xFFFF4DB8), size: 11),
                const SizedBox(width: 2),
                Text(
                  _shortNumber(diamondsSent),
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 10,
                    fontWeight: FontWeight.w900,
      ...
      children: [
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: Color(0x668E3CFF), blurRadius: 10, spreadRadius: 1),
                    BoxShadow(color: Color(0x337F35FF), blurRadius: 16),
                  ],
                ),
                child: const Stack(
                  alignment: Alignment.center,
        ...
        const Text(
          ...
          style: TextStyle(
            ...
            fontSize: 12,
            fontWeight: FontWeight.w900,
            shadows: [Shadow(color: Color(0x669C35FF), blurRadius: 5)],
          ),
        ),
      ],
    );
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(color: Color(0x664A23FF), blurRadius: 10, spreadRadius: 1),
                ],
              ),
