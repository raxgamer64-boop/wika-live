...
class _GuestCallOverlayState extends State<_GuestCallOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      fit: StackFit.expand,
      children: [
        // Host identity — compact and isolated on the top-left.
        Positioned(
          top: safeTop + 10,
          left: 12,
          right: 142,
        ...
        // Guardian + Top 3 are placed on their own row, so they never cover
        // the host chip or viewer controls.
        Positioned(
          top: safeTop + 92,
          left: 12,
          right: 12,
          ...
          child: _glass(
            ...
            child: const Row(
              ...
              children: [
                Text(
                  '◆',
                  style: TextStyle(color: Color(0xFFC85CFF), fontSize: 19),
                ),
                SizedBox(width: 7),
                Text(
                  '5.0K',
        ...
        Positioned(
          ...
          child: _glass(
            ...
            child: const Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.emoji_events_rounded, color: Color(0xFFFFD75C), size: 18),
                SizedBox(width: 5),
                Text(
                  'Top 1',
                  style: TextStyle(
          ...
          child: StreamBuilder<List<ZegoInRoomMessage>>(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: visible
                    .map((m) => _chatBubble(m.user.name, m.message))
                    .toList(),
              );
            },
          ),
        ...
        // Chat input is a separate row above the controls. It no longer
        // competes with More/Beauty/Camera/Mic/Gift for horizontal space.
        Positioned(
          left: 12,
          right: 12,
        ...
        // Compact control row. Fixed-size buttons prevent overflow on
        // narrow phones.
        Positioned(
          left: 8,
          right: 8,
          ...
          child: Row(
            ...
            children: [
              ...
              _compactGiftButton(() => _showGift(context)),
            ],
          ),
        ),
      ],
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                border: Border.all(
                  color: active ? Colors.white24 : const Color(0xFFFF5C9D),
                ),
              ),
              child: Icon(
                icon,
                color: active ? Colors.white : const Color(0xFFFF5C9D),
                size: 22,
              ),
            ),
            const SizedBox(height: 2),
  ...
  Widget _compactGiftButton(VoidCallback onTap) {
    return SizedBox(
      width: 57,
      child: InkWell(
        onTap: onTap,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            gradient: const LinearGradient(
              colors: [Color(0xFF9D2BFF), Color(0xFFFF3AA8)],
            ),
