...
class _GuestCallOverlayState extends State<_GuestCallOverlay> {
    ...
    return StreamBuilder<List<ZegoUIKitUser>>(
      ...
      builder: (context, roomSnapshot) {
        ...
        return Stack(
          fit: StackFit.expand,
          children: [
            // Small live timer. It is intentionally decorative so it never
            // interferes with ZEGO's live-session state.
            Positioned(
              top: top + 2,
              left: 0,
              right: 0,
            ...
            // TOP-LEFT HOST PROFILE
            Positioned(
              top: top + 26,
              left: 14,
              right: media.size.width * .60,
              child: _hostCard(),
            ),
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 6),
                  _roundGlass(Icons.close_rounded, 48, () => _confirmClose(context)),
                ],
              ),
            ),

            // GUARDIAN + REAL TOP 3 RANKING USERS
            Positioned(
              top: top + 18,
              left: media.size.width * .37,
              child: _guardianBadge(),
            ),
            Positioned(
              top: top + 22,
              left: media.size.width * .57,
              right: 76,
            ...
            // FUNCTIONAL ZEGO GUEST/CO-HOST CONTROL
            Positioned(
              right: 14,
              top: height * .43,
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 7),
                    const Icon(Icons.shield_rounded, color: Color(0xFFFFD33D), size: 25),
                  ],
                ),
                const SizedBox(height: 4),
                Container(
  ...
  Widget _guestSlot(BuildContext context, {bool compact = false}) {
    return InkWell(
      ...
      borderRadius: BorderRadius.circular(20),
      child: Container(
        width: compact ? 74 : 124,
        height: compact ? 74 : 124,
        decoration: BoxDecoration(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.add_rounded, color: Colors.white, size: compact ? 34 : 54),
            const SizedBox(height: 1),
            Text(
              'Guest',
              style: TextStyle(color: Colors.white, fontSize: compact ? 11 : 16, fontWeight: FontWeight.w800),
            ),
          ],
        ),
      ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(icon, color: active ? Colors.white : const Color(0xFFFF55B8), size: 27),
            ),
            const SizedBox(height: 3),
            Text(
              label,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.card_giftcard_rounded, color: Colors.white, size: 31),
            ),
            const SizedBox(height: 3),
            const Text('Gift', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w800)),
          ],
        ),
      ),
    );
