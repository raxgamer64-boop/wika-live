...
class _GuestCallOverlayState extends State<_GuestCallOverlay> {
    ...
    return StreamBuilder<List<ZegoUIKitUser>>(
      ...
      builder: (context, roomSnapshot) {
        ...
        return Stack(
          fit: StackFit.expand,
          children: [
            // COMPACT SINGLE-ROW HEADER: host + guardian + rank + viewers + close
            Positioned(
              top: top + 20,
              left: 10,
              right: 10,
              child: Row(
                ...
                children: [
                  Flexible(flex: 5, child: _hostCard()),
                  const SizedBox(width: 6),
                  _guardianBadgeSmall(),
                  const SizedBox(width: 6),
                  Flexible(flex: 3, child: _rankingUsersOnly()),
                  const SizedBox(width: 6),
                  _glass(
                  ...
                  const SizedBox(width: 6),
                  _roundGlass(Icons.close_rounded, 38, () => _confirmClose(context)),
                ],
              ),
            ),
            ...
            // FUNCTIONAL ZEGO GUEST/CO-HOST CONTROL — placed just under the header,
            // below the diamond pill row, near the top like the reference design.
            Positioned(
              right: 12,
              top: top + 160,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFD48BFF), width: 2),
            boxShadow: const [
              BoxShadow(color: Color(0xCC8E3CFF), blurRadius: 22, spreadRadius: 2),
              BoxShadow(color: Color(0x667F35FF), blurRadius: 35),
            ],
          ),
  ...
  // Compact version used inside the single-row header so it no longer
  // overlaps the host name/level badge.
  Widget _guardianBadgeSmall() {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
        ...
        const Text(
          ...
          style: TextStyle(
            ...
            shadows: [Shadow(color: Color(0xFF9C35FF), blurRadius: 6)],
          ),
        ),
      ],
    );
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.add_rounded, color: Colors.white, size: compact ? 26 : 34),
            const SizedBox(height: 1),
            Text(
              'Guest',
              style: TextStyle(color: Colors.white, fontSize: compact ? 9 : 12, fontWeight: FontWeight.w800),
            ),
          ],
        ),
      ),
