...
class _GuestCallOverlayState extends State<_GuestCallOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    // The live room is already in immersive mode. Keep the custom overlay
    // anchored to the actual video bounds so it matches the reference layout
    // instead of inheriting the device's system-bar padding.
    const top = 0.0;
    const bottom = 0.0;
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 7),
                    const Icon(Icons.shield_rounded, color: Color(0xFFFFD33D), size: 19),
                  ],
                ),
                const SizedBox(height: 4),
                Container(
              ...
              Container(
                ...
                child: const Stack(
                  ...
                  children: [
                    ...
                    Icon(Icons.star_rounded, color: Color(0xFFD8A6FF), size: 27),
                  ],
                ),
              ),
              const Positioned(
