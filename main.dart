...
class SvipAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Keep the actual profile photo perfectly circular.
    // The SVIP PNG remains a separate transparent overlay so its crown,
    // wings and bottom badge are not clipped by the photo circle.
    final base = SizedBox(
      width: size * .76,
      height: size * .76,
      child: ClipOval(
