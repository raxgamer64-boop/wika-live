...
class LiveSummaryPage extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    shape: BoxShape.circle,
                    gradient: LinearGradient(
                      colors: [Color(0xFF8B3FD9), Color(0xFFE94D9A)],
                    ),
                  ),
                ...
                Text(
                  hostName,
                  style: const TextStyle(color: Color(0xFFB9BBD0), fontSize: 15),
                ),
                const SizedBox(height: 28),
                Container(
                  padding: const EdgeInsets.all(20),
                  decoration: BoxDecoration(
                    color: const Color(0xFF121527),
                    borderRadius: BorderRadius.circular(24),
                    border: Border.all(color: const Color(0xFF2B2F49)),
                  ),
                  child: Column(
                    children: [
                      _summaryRow(Icons.timer_outlined, 'Live duration', _durationText(duration)),
                      const Divider(color: Color(0xFF292D42), height: 28),
                      _summaryRow(Icons.people_alt_outlined, 'Viewers', '$viewers'),
                      const Divider(color: Color(0xFF292D42), height: 28),
                      _summaryRow(Icons.card_giftcard_rounded, 'Gifts received', '$gifts'),
                    ],
                  ),
                ),
                const SizedBox(height: 14),
                const Text(
                  'Gift earnings will appear here once WikaLive gifts are connected to the live room.',
                  textAlign: TextAlign.center,
                  style: TextStyle(color: Color(0xFF777C91), fontSize: 12, height: 1.4),
                ),
                const SizedBox(height: 28),
                SizedBox(
  ...
  Widget _summaryRow(IconData icon, String label, String value) {
    return Row(
      children: [
        Icon(icon, color: const Color(0xFFD58CFF), size: 26),
        const SizedBox(width: 14),
        Expanded(
          child: Text(label, style: const TextStyle(color: Color(0xFFB9BBD0), fontSize: 14)),
        ),
        Text(
          value,
