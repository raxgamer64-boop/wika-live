...
class _LiveRoomPageState extends State<LiveRoomPage> {
  ...
  Widget _liveVideoBackground(String? url) {
    // Do not use the host's DP as the full-screen "video".
    // A profile photo is only an avatar; the real app should later
    // provide the actual streaming SDK/video surface here.
    return _placeholderVideo(url);
  }

  Widget _placeholderVideo(String? avatarUrl) {
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment.topCenter,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    gradient: const LinearGradient(
                      colors: [Color(0xFFFF45C8), Color(0xFF7B4DFF)],
                    ),
                    boxShadow: const [
                      BoxShadow(
                        color: Color(0x774B22FF),
                        blurRadius: 28,
                        spreadRadius: 4,
                      ),
                    ],
                  ...
                  child: CircleAvatar(
                    backgroundColor: const Color(0xFF1B1534),
                    backgroundImage:
